...
/* u8/u16/u32 already defined in <linux/types.h> — no redefinition needed */
...
/* Register configuration table (defined here, declared in ktz8866.h) */
struct ktz8866_reg ktz8866_regs_conf[] = {
	...
	{ KTZ8866_DISP_FULL_CURRENT, 0xb1 }, /* CSOT panel Full-scale LED Current 22.8mA */
	{ KTZ8866_DISP_BC2, 0xbd },       /* LED ramping time 128ms */
	{ KTZ8866_DISP_DIMMING, 0x11 },   /* LED on/off ramping time 1ms */
	{ KTZ8866_DISP_BIAS_CONF1, 0x9f }, /* OUTP/OUTN enabled via ENP/ENN pins */
	{ KTZ8866_DISP_BL_ENABLE, 0x5f }, /* BL_EN enable */
};

/* Brightness level remapping table (2048 entries for 11-bit brightness) */
